...
class TransformerParallelConvBlock(nn.Module):
    def __init__(self, in_planes, out_planes, stride=1):
        ...
        self.transformer = Transformer(dims01, depth=4, heads=10, dim_head=2, mlp_dim=dims[3])
...
class Super_MiniSeg(nn.Module):
    def __init__(self, in_chns=1, class_num=2,P1=1, P2 = 2, P3=2, aux=False):
        ...
        self.long1 = DilatedParallelConvBlock(self.in_chns,8,stride=1)
        self.down1 = DilatedParallelConvBlock(self.in_chns,8,stride=1)
        self.long1_02 = DilatedParallelConvBlock(8, 8, stride=2)
        self.down1_02 = DilatedParallelConvBlock(8, 8, stride=2)
        ...
        for i in range(0, P1):
            self.level1.append(DilatedParallelConvBlock(8,8))
        for i in range(0, self.D1):
            self.level1_long.append(TransformerParallelConvBlock(8,8))
        ...
        self.long2 = DilatedParallelConvBlock(8, 24, stride=2)
        ...
        for i in range(0, self.D2):
            self.level2_long.append(TransformerParallelConvBlock(24, 24))
        ...
        self.long3 = DilatedParallelConvBlock(24, 32, stride=2)
        ...
        for i in range(0, self.D3):
            self.level3_long.append(TransformerParallelConvBlock(32, 32))


        # self.level3= DilatedParallelConvBlock(32, 32)
