...
parser.add_argument('--model', type=str,  default='supermini', help='model_name')
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                for i_batch, sampled_batch in enumerate(valloader):
                    metric_i = test_single_volume_covid(sampled_batch["image"], sampled_batch["label"], model, classes=num_classes)
